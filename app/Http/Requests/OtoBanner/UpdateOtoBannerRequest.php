...
class UpdateOtoBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', Rule::enum(OtoBannerStatus::class)],
            'device_type' => ['sometimes', Rule::enum(OtoBannerDeviceType::class)],
            ...
            'input_field_enabled' => ['sometimes', 'boolean'],
            'input_field_type' => ['sometimes', Rule::enum(OtoBannerInputFieldType::class)],
            'input_field_label' => ['nullable', 'string', 'max:255'],
            'input_field_placeholder' => ['nullable', 'string', 'max:255'],
            'input_field_required' => ['sometimes', 'boolean'],

            'display_delay_seconds' => ['sometimes', 'integer', 'min:0', 'max:3600'],
