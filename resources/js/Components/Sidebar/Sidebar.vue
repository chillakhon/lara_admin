                    ...
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            <a :href="route('dashboard')"
                               :class="route().current('dashboard') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                        ...
                        <li>
                            <DropDownItem
                                ...
                                {
                                    title: 'Цвета',
                                    route: 'dashboard.color-management.index',
                                }
                            ]"
                            >
                                <template #prefix>
                        ...
                        <li>
                            <a :href="route('dashboard.categories.index')"
                               :class="route().current('dashboard.categories.index') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <li>
                            <a :href="route('dashboard.products.index')"
                               :class="route().current('dashboard.products.index') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true"
                        ...
                        <li>
                            <a :href="route('dashboard.clients.index')"
                               :class="route().current('dashboard.clients.index') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <li>
                            <a :href="route('dashboard.orders.index')"
                               :class="route().current('dashboard.orders.index') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <li>
                            <a :href="route('dashboard.users.index')"
                               :class="route().current('dashboard.users.index') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
