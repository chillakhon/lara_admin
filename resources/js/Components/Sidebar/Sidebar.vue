                    ...
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            <DropDownItem
                                ...
                                :links="[
                                    ...
                                    {
                                        title: 'Статистика',
                                        route: 'dashboard.production.statistics',
                                    },
                                ]"
                            >
                                <template #prefix>
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    route().current('dashboard.products.index')
                                        ? 'bg-gray-100 dark:bg-gray-700'
                                        : ''
                                "
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    route().current('dashboard.clients.index')
                                        ? 'bg-gray-100 dark:bg-gray-700'
                                        : ''
                                "
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    route().current('dashboard.leads.index')
                                        ? 'bg-gray-100 dark:bg-gray-700'
                                        : ''
                                "
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    route().current('dashboard.orders.index')
                                        ? 'bg-gray-100 dark:bg-gray-700'
                                        : ''
                                "
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <li>
                            <DropDownItem
                                ...
                                :links="[
                                    {
                                        title: 'Промокоды',
                                        route: 'dashboard.promo-codes.index',
                                    },
                                    {
                                        title: 'Уровни клиентов',
                                        route: 'dashboard.client-levels.index',
                                    },
                                ]"
                            >
                                <template #prefix>
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    route().current('dashboard.users.index')
                                        ? 'bg-gray-100 dark:bg-gray-700'
                                        : ''
                                "
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                            ...
                            <DropDownItem
                                ...
                                :links="[
                                    ...
                                    },
                                    {
                                        ...
                                        route: 'dashboard.task-statuses.index',
                                    }
                                ]"
                            >
                                <template #prefix>
                        ...
                        <li>
                            <a
                                ...
                                :class="route().current('dashboard.reviews.*') ? 'bg-gray-100 dark:bg-gray-700' : ''"
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                            >
                                <svg
                                    class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        ...
                        <li>
                            <DropDownItem
                                ...
                                :links="[
                                    {
                                        title: 'Отправления',
                                        route: 'dashboard.delivery.shipments.index',
                                    },
                                    {
                                        title: 'Методы доставки',
                                        route: 'dashboard.delivery.methods.index',
                                    }
                                ]"
                            >
                                <template #prefix>
                            ...
                            <DropDownItem
                                ...
                                :links="[
                                    ...
                                    },
                                    {
                                        ...
                                        route: 'dashboard.settings.delivery',
                                    },
                                ]"
                            >
                                <template #prefix>
